...
## 动态规划的适用范围
1.  用于优化问题（求最优解），需满足 **最优子结构** 和 **重叠子问题**
2.  用于递推问题（求值），仅需满足 **重叠子问题** 例如：斐波拉契数列

### 最优子结构

1.  具有最优子结构也 **可能** 是适合用贪心的方法求解（贪心的条件更加苛刻：最优子结构+贪心选择性质([局部最优推导全局最优](https://www.yuque.com/u22468780/ysrk1p/wszxk5x9vx0bicse)))。
2.  贪心通常 **不具有重叠子问题**，部分问题含有 **最优子结构**，所以贪心最本质的特征是 **贪心选择性质**，动态规划的核心特征是 **重叠子问题** 
